...
PLAUSIBLE_RANGE: dict[str, tuple[float, float]] = {
    ...
    "USDCHF": (0.70, 1.15), "EURJPY": (105.0, 185.0), "GBPJPY": (115.0, 215.0),
    "AUDJPY": (55.0, 115.0), "NZDJPY": (55.0, 105.0), "CADJPY": (68.0, 125.0),
    "CHFJPY": (100.0, 195.0), "EURGBP": (0.80, 0.98), "EURAUD": (1.40, 2.05),
    "EURCHF": (0.88, 1.20), "EURCAD": (1.35, 1.70), "GBPAUD": (1.60, 2.15),
    "GBPCHF": (1.00, 1.40), "AUDNZD": (1.00, 1.20),
}
